...
export const simulationsPosts = [
  ...
  {
    id: 'organization-oregon-food-bank-003',
    uuid: sessionless.generateUUID(),
    ...
    tags: ['charity', 'food-bank', 'oregon', 'hunger-relief', 'community'],
    metadata: {
      type: 'nonprofit',
      taxExempt: true,
...
/**
 * Generate SVG for Oregon Food Bank charity organization
 * Visual representation with brand colors and mission
 *
 * @param {Object} organization - Organization object
 * @param {string} organizationBDOPubKey - PubKey of this organization's BDO
 * @returns {string} SVG string
 */
export function generateOregonFoodBankSVG(organization, organizationBDOPubKey) {
  return `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 400 360" width="400" height="360">
  <defs>
    <linearGradient id="bgGradient" x1="0%" y1="0%" x2="0%" y2="100%">
      <stop offset="0%" style="stop-color:#4DA00F;stop-opacity:1" />
      <stop offset="100%" style="stop-color:#3d8008;stop-opacity:1" />
    </linearGradient>

    <linearGradient id="saveGrad" x1="0%" y1="0%" x2="100%" y2="100%">
      <stop offset="0%" style="stop-color:#4DA00F;stop-opacity:1" />
      <stop offset="50%" style="stop-color:#F59420;stop-opacity:1" />
      <stop offset="100%" style="stop-color:#4DA00F;stop-opacity:1" />
    </linearGradient>

    <filter id="saveGlow" x="-50%" y="-50%" width="200%" height="200%">
      <feGaussianBlur in="SourceAlpha" stdDeviation="4"/>
      <feOffset dx="0" dy="0" result="offsetblur"/>
      <feFlood flood-color="#F59420" flood-opacity="0.8"/>
      <feComposite in2="offsetblur" operator="in"/>
      <feMerge>
        <feMergeNode/>
        <feMergeNode in="SourceGraphic"/>
  ...
  <!-- Background -->
  <rect x="0" y="0" width="400" height="360" fill="url(#bgGradient)" rx="12"/>
  ...
  <!-- Organization name -->
  <text class="org-title" x="200" y="120">Oregon Food Bank</text>
  <text class="org-subtitle" x="200" y="138">Fighting Hunger in Oregon & SW Washington</text>

  <!-- Mission statement -->
  <rect x="30" y="155" width="340" height="35" fill="rgba(255,255,255,0.1)" rx="6"/>
  <text class="mission-text" x="200" y="170">"To eliminate hunger and its root causes</text>
  <text class="mission-text" x="200" y="183">because no one should be hungry"</text>

  <!-- Impact stats -->
  <text class="info-text" x="30" y="210">📍 Serving Oregon & SW Washington</text>
  <text class="info-text" x="30" y="227">🏢 Network of 1,400+ partner agencies</text>
  <text class="info-text" x="30" y="244">🍎 Fresh produce distribution</text>
  <text class="info-text" x="30" y="261">📊 1 in 8 Oregonians faces hunger</text>
  <text class="info-text" x="30" y="278">✊ Policy advocacy & education</text>

  <!-- Website link -->
  <text class="link-text" x="200" y="295">oregonfoodbank.org</text>
  ...
  <rect
    ...
    rx="12"
    spell="save"
    spell-components='{"bdoPubKey":"${organizationBDOPubKey}","collection":"games"}'
  />
